<!doctype html>
<html lang="nb"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Champions League – utskrift | Innsatt.no</title>
<style>
...
<header><div><strong>Innsatt.no</strong><h1>Champions League</h1><span>Sesongen 2026/27</span></div><div class="meta">Generert {{ $generatedAt->locale('nb')->translatedFormat('j. F Y \k\l. H.i') }}</div></header>
