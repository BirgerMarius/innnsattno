...
@section('title', 'Premier League API-test | INNSATT.NO')
...
<div class="container my-5">
    ...
    <p>Denne siden viser teknisk status for Premier League-koblingen uten API-nøkler eller sensitive headere.</p>
