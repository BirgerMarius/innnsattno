...
{
    private const CACHE_KEY = 'public-change-history.v3';
    ...
    private const MESSAGE_TRANSLATIONS = [
        ...
        'Show country flags' => 'Vis landsflagg',
        'Show flags for finished and upcoming matches' => 'Vis flagg for ferdigspilte og kommende kamper',
        'Inspect countryFlag' => 'Undersøk countryFlag',
        'Inspect country flag data' => 'Undersøk data for landsflagg',
        'Inspect participant data' => 'Undersøk deltakerdata',
        'Inspect team images' => 'Undersøk lagbilder',
        'Debug participants' => 'Feilsøk deltakere',
        'Debug flag data' => 'Feilsøk flaggdata',
        'Debug England country code' => 'Feilsøk landskode for England',
        'Debug countryCode i gruppetabeller' => 'Feilsøk countryCode i gruppetabeller',
        'Debug bonnetider' => 'Feilsøk bønnetider',
        'Debug første ferdigspilte sluttspillkamp' => 'Feilsøk første ferdigspilte sluttspillkamp',
        'Debug uavgjort sluttspillkamp' => 'Feilsøk uavgjort sluttspillkamp',
        'Fjernet debug for country codes' => 'Fjern feilsøking for landskoder',
        'Fjern debug og rydd kampvisning' => 'Fjern feilsøking og rydd kampvisning',
        ...
        'Tidsfordriv: modernize Sudoku and Word Search' => 'Tidsfordriv: moderniser Sudoku og ordjakt',
        'TV: open print dialog automatically' => 'TV: åpne utskriftsdialogen automatisk',
        'Onboard innsatt.no in ASF and complete WP-0001' => 'Ta innsatt.no inn i ASF og fullfør WP-0001',
        ...
        'Make front page more compact' => 'Gjør forsiden mer kompakt',
        ...
        'Configure targeted AI Factory test gate' => 'Konfigurer målrettet testkontroll for AI Factory',
        ...
        'Stabilize Laravel test suite' => 'Stabiliser Laravel-testene',
        ...
        'Upgrade assignment wheel experience' => 'Forbedre brukeropplevelsen for Oppdragshjulet',
        ...
        'Refine flag day display and royal ages' => 'Finjuster visning av flaggdager og kongelige aldre',
        ...
        'Return to TV page after printing' => 'Gå tilbake til TV-siden etter utskrift',
        ...
        'Show all pages in admin statistics' => 'Vis alle sider i administrasjonsstatistikken',
